<template>
    <section class="portfolio-area section-gap" id="portfolio">
		<div class="container">
			...
			<div id="item" class="filters-content">
				<div class="row grid">
			...
			<div id="item" class="single-portfolio col-sm-4 all personal">
				<div class="item">
			...
			<div id="item" class="single-portfolio col-sm-4 all agency">
				<div class="item">
			...
			<div id="item" class="single-portfolio col-sm-4 all portal">
				<div class="item">
            ...
            <div id="item" class="single-portfolio col-sm-4 all corporate">
				<div class="item">
...
function myFunction() {
  document.getElementsByTagName("item").nodeValue = "initial";
}
