<template>
    <section class="portfolio-area section-gap" id="portfolio">
		<div class="container">
			...
			<div class="filters-content" onclick="myScript">
				<div class="row grid">
			...
			<div class="single-portfolio col-sm-4 all personal" onclick="myScript">
				<div class="item">
			...
			<div class="single-portfolio col-sm-4 all agency" onclick="myScript">
				<div class="item">
			...
			<div class="single-portfolio col-sm-4 all portal" onclick="myScript">
				<div class="item">
            ...
            <div class="single-portfolio col-sm-4 all corporate" onclick="myScript">
				<div class="item">
