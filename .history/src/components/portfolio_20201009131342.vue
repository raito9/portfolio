		...
		<div class="container">
			...
			<div class="filters">
				<ul>
				    ...
				    <li id="demo" data-filter=".corporate">Vector</li>
				    <li id="demo" data-filter=".personal">Raster</li>
				    <li id="demo" data-filter=".agency">UI/UX</li>
				    <li id="demo" data-filter=".portal">Printing</li>
				</ul>
			</div>
...
function myFunction() {
  var txt = nodeValue = "data-filter='.corporate'";
  document.getElementsByTagName("demo").innerHTML = txt;
}
